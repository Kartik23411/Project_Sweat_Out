    ...
    Column(
        ...
        Text(
            modifier = Modifier
                    .fillMaxWidth()
                    .padding(top = 32.dp),
            text = stringResource(R.string.age_selection_screen_headline),
        ...
        Text(
            ...
            text = stringResource(R.string.age_selection_screen_about_text),
...
@Composable
private fun AgeSelectionScreenPreview() {
    SweatOutTheme {
        AgeSelectionScreen(
            modifier = Modifier
                    .fillMaxSize()
